...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts linking to bots, services, and other posts';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedBots: Schema.Attribute.Relation<'manyToMany', 'api::bot.bot'>;
...
export interface ApiBotBot extends Struct.CollectionTypeSchema {
  collectionName: 'bots';
  info: {
    description: 'Appilot automation bot products';
    displayName: 'Bot';
    pluralName: 'bots';
    singularName: 'bot';
  };
  ...
  attributes: {
    ...
    manualRelatedBots: Schema.Attribute.Relation<'manyToMany', 'api::bot.bot'>;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  collectionName: 'faqs';
  info: {
    description: 'Frequently asked questions linked to bots and services';
    displayName: 'FAQ';
    pluralName: 'faqs';
    singularName: 'faq';
  };
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<['General', 'Pricing', 'Technical']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPlatformPlatform extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Social media and messaging platforms (hub pages)';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['social-media', 'messaging', 'ecommerce', 'dating']
    > &
      Schema.Attribute.Required;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Appilot service offerings (automation, scraping, development, custom)';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Automation', 'Scraping', 'Development', 'Custom']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    typicalDuration: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer reviews linked to specific bots and services';
  ...
  attributes: {
    ...
    relatedBot: Schema.Attribute.Relation<'manyToOne', 'api::bot.bot'>;
...
export interface ApiUseCaseUseCase extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categorizes bots by purpose (growth, data-extraction, lead-generation, etc.)';
    displayName: 'UseCase';
  ...
  attributes: {
    bots: Schema.Attribute.Relation<'manyToMany', 'api::bot.bot'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
